...
class AllMediaSliderScreen extends StatefulWidget {
  final String title;
  final List<MediaModel> medias;
  final int initialIndex;
  final Function(int)? onPageChanged;

  static const String name = 'All Media Slider';
  static const String routePath = '/all_media_slider';

  const AllMediaSliderScreen({
    super.key,
  ...
  @override
  State<AllMediaSliderScreen> createState() => _ImageSliderState();
}

class _ImageSliderState extends State<AllMediaSliderScreen> {

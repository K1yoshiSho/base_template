...
void main() {
  ...
  test('Parse urls', () {
    final segments = parseText(
        'https://flutter.dev flutter.dev http://flutter.dev/docs/get-started flutter.dev/docs/get-started en.wikipedia.org/wiki/Flutter_(software) amazon.co.uk amazon.co.uk/s?k=flutter');
